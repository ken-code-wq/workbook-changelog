...
import { DevModeOverview } from "@/components/dev-mode-overview"
import { ReleaseDevCard } from "@/components/release-dev-card"
  ...
  return (
    <DevModeProvider>
      <div className="min-h-screen bg-background relative selection:bg-primary/20">
        {/* Floating Sticky Header with Dev Mode Toggle */}
        <SiteHeader />
        ...
        {/* Main Content Area */}
        <main className="max-w-4xl mx-auto px-6 lg:px-10 pt-10 pb-20">
          {/* Developer Cockpit (Visible when Dev Mode is toggled on) */}
          <DevModeOverview />
                  ...
                  <div className="flex flex-col md:flex-row gap-y-6">
                    ...
                    <div className="flex-1 md:pl-8 relative pb-14">
                      ...
                      <div className="space-y-5">
                        ...
                        {/* Customer-friendly feature bullet sections */}
                        ...
                        {/* Developer Telemetry Breakdown (Git Kraken Style) */}
                        <ReleaseDevCard date={changelog.date} devStats={changelog.devStats} />
                      </div>
                    </div>
                  </div>
                </article>
